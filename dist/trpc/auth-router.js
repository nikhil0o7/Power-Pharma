...
exports.authRouter = (0, trpc_1.router)({
        ...
        return __awaiter(void 0, void 0, void 0, function () {
            ...
            return __generator(this, function (_b) {
                switch (_b.label) {
                    ...
                    case 3:
                        _b.sent();
                        return [2 /*return*/, { sucess: true, sentToEmail: email }];
                }
            });
        });
    }),
    ...
    resend: trpc_1.publicProcedure
        .input(zod_1.z.object({ email: zod_1.z.string(), name: zod_1.z.string(), message: zod_1.z.string() }))
        .mutation(function (_a) {
        var input = _a.input;
        return __awaiter(void 0, void 0, void 0, function () {
            var name, email, message, resend, data, e_1;
            return __generator(this, function (_b) {
                switch (_b.label) {
                    case 0:
    ...
    signIn: trpc_1.publicProcedure
        ...
        return __awaiter(void 0, void 0, void 0, function () {
            var email, password, res, payload, e_2;
            return __generator(this, function (_b) {
                switch (_b.label) {
                    case 0:
                        email = input.email, password = input.password;
