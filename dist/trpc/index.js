...
exports.appRouter = (0, trpc_1.router)({
    ...
    manufacturers: trpc_1.publicProcedure
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                ...
                case 2:
                    manufacturers = (_a.sent()).docs;
                    return [2 /*return*/, manufacturers];
            }
        });
    }); }),
    categories: trpc_1.publicProcedure
        .input(zod_1.z.object({
        limit: zod_1.z.number().min(1).max(100),
        id: zod_1.z.string().nullish(),
    }))
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                ...
                case 2:
                    categories = (_a.sent()).docs;
                    return [2 /*return*/, categories];
            }
        });
    }); }),
    products: trpc_1.publicProcedure
        .input(zod_1.z.object({
        limit: zod_1.z.number().min(1).max(100),
    }))
        .query(function () { return __awaiter(void 0, void 0, void 0, function () {
    ...
    getInfiniteMfgProducts: trpc_1.publicProcedure
        .input(zod_1.z.object({
        limit: zod_1.z.number().min(1).max(100),
        cursor: zod_1.z.number().nullish(),
        manufacturer: zod_1.z.any().nullish(),
        product_category: zod_1.z.any().nullish(),
        query: query_validator_1.MfgQueryValidator,
    }))
        .query(function (_a) {
        var input = _a.input;
        return __awaiter(void 0, void 0, void 0, function () {
            var query, cursor, sort, limit, product_category, manufacturer, payload, parsedQueryOpts, page, _b, items, hasNextPage, nextPage;
            return __generator(this, function (_c) {
                switch (_c.label) {
                    case 0:
                        query = input.query, cursor = input.cursor;
                        sort = query.sort, limit = query.limit, product_category = query.product_category, manufacturer = query.manufacturer;
                        return [4 /*yield*/, (0, get_payload_1.getPayloadClient)()];
                    case 1:
                        payload = _c.sent();
                        parsedQueryOpts = {};
